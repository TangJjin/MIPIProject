...
void MX_DSIHOST_DSI_Init(void)
{
  ...
  VidCfg.HorizontalSyncActive = 50;
  VidCfg.HorizontalBackPorch = 100;
  VidCfg.HorizontalLine = 1250;
  VidCfg.VerticalSyncActive = 60;
  VidCfg.VerticalBackPorch = 70;
  VidCfg.VerticalFrontPorch = 70;
...
void HAL_DSI_MspInit(DSI_HandleTypeDef* dsiHandle)
{
  ...
  /* USER CODE BEGIN DSI_MspInit 0 */
    ...
    /* Reset the DSI host before configuring the PHY and video engine. */
